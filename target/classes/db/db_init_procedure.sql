DELIMITER //
    ...
    BEGIN
        ...
        WHILE counter < numUsers DO
			# counter will be used also as user_id
			SET counter = counter + 1;
            # random number to determine how many records will be created for this user
